...
aklog cs.cmu.edu
cd /afs/cs.cmu.edu/academic/class/11785-f19/
mv www archive/www-bak-$(date +%d-%m-%Y)
git clone https://github.com/jhkonan/jhkonan.github.io.git www
```

## To view the updated website, go to:
