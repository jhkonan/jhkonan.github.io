(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[40],{"/Xzx":function(e,t){(function(e){"use strict"
...
Promise.all([i.e(6),i.e(566)]).then(i.bind(null,"z8T/")).then(e=>{let i=e.default
...
u["a"].MepDefaults.success=function(e,t){i.e(578).then(i.bind(null,"ozaW")).then(t=>{let i=t.default
...
var _=false
var b=null
c.a.mediaComment.init=function(e,t){Promise.all([i.e(6),i.e(20),i.e(210),i.e(343)]).then(function(){var a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
...
d.dialog("option","close",function(){c()("#audio_record").before("<div id='audio_record'/>").remove()
...
var x,T
_=true
setInterval(function(){if(_){h=c()("#audio_record_holder")
g=c()("#audio_record")
...
c()("#audio_record_holder").addClass("with_volume").animate({width:420},function(){b.css("display","")})}if(v>4){y=0
v=0
var i=(e-e%10)/10
...
const n=o();("Chrome"===n.name&&Number(n.version)>=68||"Firefox"===n.name&&Number(n.version)>=61)&&Promise.all([i.e(1),i.e(2),i.e(3),i.e(4),i.e(5),i.e(7),i.e(8),i.e(9),i.e(10),i.e(11),i.e(13),i.e(18),i.e(23),i.e(75),i.e(80),i.e(549)]).then(i.bind(null,"kImW")).then(e=>{let t=e.default
let i
...
c.a.ajaxJSON("/api/v1/services/kaltura_session","POST",{},function(e){u.data("ks",e.ks)
u.data("uid",e.uid)},function(e){false==e.logged_in?u.data("ks-error",n.t("errors.must_be_logged_in","You must be logged in to record media.")):u.data("ks-error",n.t("errors.load_failed","Media Comment Application failed to load.  Please try again."))})
...
//# sourceMappingURL=40-c-ecaa48e090.js.map